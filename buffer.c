...
void daklakwl_buffer_convert_romaji(struct daklakwl_buffer *buffer) {
    ...
    if (c2 == 'n' && c3 == '\'') {
        daklakwl_buffer_delete_backwards(buffer, 2);
    ...
    if (c2 == c3 && twos[c3]) {
        daklakwl_buffer_delete_backwards(buffer, 2);
        daklakwl_buffer_append(buffer, "っ");
        daklakwl_buffer_append(buffer, (char[]){c3, 0});
    }
    ...
    if (c1 == 's' && c2 == 'h' && c3 == 'i') {
        daklakwl_buffer_delete_backwards(buffer, 3);
        daklakwl_buffer_append(buffer, "し");
        return;
    }

    if (c1 == 'c' && c2 == 'h' && c3 == 'i') {
        daklakwl_buffer_delete_backwards(buffer, 3);
        daklakwl_buffer_append(buffer, "ち");
        return;
    }
    ...
    if (c1 == 't' && c2 == 's' && c3 == 'u') {
        if (c0 == 'x' || c0 == 'l') {
            daklakwl_buffer_delete_backwards(buffer, 4);
            daklakwl_buffer_append(buffer, "っ");
            return;
        }
        daklakwl_buffer_delete_backwards(buffer, 3);
        daklakwl_buffer_append(buffer, "つ");
        return;
    }
    ...
    if (c1 && c2 == 'y' && youon[c3]) {
        daklakwl_buffer_delete_backwards(buffer, 3);
        if (c1 != 'x' && c1 != 'l')
            daklakwl_buffer_append(buffer, twos[c1]['i']);
        daklakwl_buffer_append(buffer, youon[c3]);
        return;
    }

    if (c2 && twos[c2] && twos[c2][c3]) {
        daklakwl_buffer_delete_backwards(buffer, 2);
        daklakwl_buffer_append(buffer, twos[c2][c3]);
        return;
    }

    if (ones[c3]) {
        daklakwl_buffer_delete_backwards(buffer, 1);
        daklakwl_buffer_append(buffer, ones[c3]);
        return;
    }
}
